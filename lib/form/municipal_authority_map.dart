...
class MunicipaiAuthorityMap extends StatelessWidget {
  MunicipaiAuthorityMap({Key? key, required this.feature}) : super(key: key);

  GeoJSONFeature feature;

  static const String route = '/MunicipaiAuthorityMap';
    ...
    markers.add(
      Marker(
        ...
        infoWindow: InfoWindow(
            title: feature.properties!['address']['address_formatted']),
      ),
    );
